 ...
 * \returns a random boundary value for the given range and domain or 0 with error set
 */
Uint16 SDLCALL SDLTest_RandomUint16BoundaryValue(
    Uint16 boundary1, Uint16 boundary2, bool validDomain);
 ...
 * \returns a random boundary value for the given range and domain or 0 with error set
 */
Uint32 SDLCALL SDLTest_RandomUint32BoundaryValue(
    Uint32 boundary1, Uint32 boundary2, bool validDomain);
 ...
 * \returns a random boundary value for the given range and domain or 0 with error set
 */
Uint64 SDLCALL SDLTest_RandomUint64BoundaryValue(
    Uint64 boundary1, Uint64 boundary2, bool validDomain);
 ...
 * RandomSint8BoundaryValue(SINT8_MIN, SINT8_MAX, false) returns SINT8_MIN (== error value) with
 * error set
 *
 * \param boundary1 Lower boundary limit
 * \param boundary2 Upper boundary limit
 ...
 * RandomSint16BoundaryValue(SINT16_MIN, SINT16_MAX, false) returns SINT16_MIN (== error value) with
 * error set
 *
 * \param boundary1 Lower boundary limit
 * \param boundary2 Upper boundary limit
 ...
 */
Sint16 SDLCALL SDLTest_RandomSint16BoundaryValue(
    Sint16 boundary1, Sint16 boundary2, bool validDomain);
 ...
 */
Sint32 SDLCALL SDLTest_RandomSint32BoundaryValue(
    Sint32 boundary1, Sint32 boundary2, bool validDomain);
 ...
 * RandomSint64BoundaryValue(SINT64_MIN, SINT64_MAX, false) returns SINT64_MIN (== error value) and
 * error set
 *
 * \param boundary1 Lower boundary limit
 * \param boundary2 Upper boundary limit
 ...
 */
Sint64 SDLCALL SDLTest_RandomSint64BoundaryValue(
