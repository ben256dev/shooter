...
int SDLTest_GetFuzzerInvocationCount(void) { return fuzzerInvocationCounter; }
 ...
 */
static Uint64 SDLTest_GenerateUnsignedBoundaryValues(
    const Uint64 maxValue, Uint64 boundary1, Uint64 boundary2, bool validDomain)
{
    Uint64 b1, b2;
    Uint64 delta;
    Uint64 tempBuf[4];
...
Uint8 SDLTest_RandomUint8BoundaryValue(Uint8 boundary1, Uint8 boundary2, bool validDomain)
{
    ...
    return (Uint8)SDLTest_GenerateUnsignedBoundaryValues(
        maxValue, (Uint64)boundary1, (Uint64)boundary2, validDomain);
}
...
Uint16 SDLTest_RandomUint16BoundaryValue(Uint16 boundary1, Uint16 boundary2, bool validDomain)
{
    ...
    return (Uint16)SDLTest_GenerateUnsignedBoundaryValues(
        maxValue, (Uint64)boundary1, (Uint64)boundary2, validDomain);
}
...
#endif
    return (Uint32)SDLTest_GenerateUnsignedBoundaryValues(
        maxValue, (Uint64)boundary1, (Uint64)boundary2, validDomain);
}
...
Uint64 SDLTest_RandomUint64BoundaryValue(Uint64 boundary1, Uint64 boundary2, bool validDomain)
{
    ...
    return SDLTest_GenerateUnsignedBoundaryValues(maxValue, boundary1, boundary2, validDomain);
}
 ...
 * \returns Returns a random boundary value for the domain or 0 in case of error
 */
static Sint64 SDLTest_GenerateSignedBoundaryValues(const Sint64 minValue, const Sint64 maxValue,
    Sint64 boundary1, Sint64 boundary2, bool validDomain)
{
    Sint64 b1, b2;
    Sint64 delta;
    Sint64 tempBuf[4];
...
Sint8 SDLTest_RandomSint8BoundaryValue(Sint8 boundary1, Sint8 boundary2, bool validDomain)
{
    ...
    return (Sint8)SDLTest_GenerateSignedBoundaryValues(
...
Sint16 SDLTest_RandomSint16BoundaryValue(Sint16 boundary1, Sint16 boundary2, bool validDomain)
{
    ...
    return (Sint16)SDLTest_GenerateSignedBoundaryValues(
        minValue, maxValue, (Sint64)boundary1, (Sint64)boundary2, validDomain);
}
...
Sint64 SDLTest_RandomSint64BoundaryValue(Sint64 boundary1, Sint64 boundary2, bool validDomain)
{
    ...
    return SDLTest_GenerateSignedBoundaryValues(
        minValue, maxValue, boundary1, boundary2, validDomain);
}

float SDLTest_RandomUnitFloat(void) { return SDL_randf_r(&rndContext); }
...
char* SDLTest_RandomAsciiString(void) { return SDLTest_RandomAsciiStringWithMaximumLength(255); }
