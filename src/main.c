...
SDL_AppResult SDL_AppIterate(void* appstate)
{
    ...
    //(vec3) { .x = 0.0f, .y = 0.0f, .z = 0.0f }, (vec3) { .x = 1.0f, .y = 1.0f, .z = 1.0f });
    mat4_translation(&r, (vec3) { .x = 0.0f, .y = 0.0f, .z = -2.0f });
    mat4_rotation_from_vec3(&l, (vec3) { .x = 0.0f, .y = 1.5f, .z = 0.0f });
    mat4_mul_mat4(&_mat4s[0], l, r);
